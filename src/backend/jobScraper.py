...
def extract_all_jobs_from_ffwd():
    ...
    for role in roles:
        jobs_html_list = load_ffwd_jobs(role)
...
def extract_one_job_ffwd(html_list_item, role = ''):
    # <li class="row"><article class="opportunities-content col-lg-8 col-md-12"><h2>
    # <a href="https://www.ffwd.org/tech-nonprofit-jobs/s/mifos-initiative-volunteer/">Volunteer</a></h2>
    # <p class="locations font-tiny">Dec 17, 2020 | Mifos Initiative  | </p>
    # <p class="program-areas font-tiny"><em>Impact in</em> Poverty Alleviation &amp; Economic Development</p>
    # </article><figure class="col-lg-4"><a href="https://www.ffwd.org/tech-nonprofit-jobs/s/mifos-initiative-volunteer/">
    # <img alt="Mifos Initiative" height="101" src="https://www.ffwd.org/wp-content/uploads/Mifos-Logo-No-tag-transparentpn-2-250x101.png" width="250"/></a></figure></li>
